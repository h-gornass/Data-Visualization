...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        ...
        exp_rec= recession_period.groupby('Vehicle_Type')['Advertising_Expenditure'].sum().reset_index()
        R_chart3 = dcc.Graph(figure=px.pie(est_data, 
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unemp_sales = recession_data.groupby(['Unemployment_Rate', 'Vehicle_Type'])['Automobile_Sales'].sum().reset_index() 
        R_chart4 = dcc.Graph(figure=px.bar(unemp_rate,
        x='Unemployment rate', 
        y='Automobile Sales',
        title='Unemployment rate effect on Automobile Sales'
        ))
